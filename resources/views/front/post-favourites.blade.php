    ...
    <div class="container">
        ...
        <nav class="my-5" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">المقالات المفضله</li>
            ...
            <div class="container">
                ...
                <div class="slick2">
                    ...
                    <div class="slick-cont">
                            ...
                            <div class="card">
                                <img src="{{asset($favourite->image)}}" class="card-img-top" width="300px" height="250px" alt="slick-img">
                                <div class="heart-icon"><i class="far fa-heart"></i></div>
                                <div class="card-body">
                                    <h5 class="card-title">{{$favourite->title}}</h5>
                                    <p>{{$favourite->small_desc}}
                                    </p>
                                    <div class="text-center"><a href="{{route('post-details' ,$favourite->id)}}"
