                ...
                <div class="slick2">
                    ...
                    @foreach($posts->take(10)->get() as $post)
                        <div class="slick-cont">
                            ...
                            <div class="card">
                                <div class="heart-icon"><i id="{{$post->id}}" onclick="toggleFavourite({{$post->id}})" class="far fa-heart
                                    {{$post->is_favourite ? 'second-heart' : 'first-heart'}}"></i>
                                </div>
                                <img src="{{$post->image}}" class="card-img-top" alt="slick-img" width="300px "
                                     height="200px">
                                <div class="card-body">
    ...
    <section class="donation">
        ...
        <div class="donation-request py-5">
            <div class="container">
                ...
                <form action="{{url(route('home-search'))}}" method="get" class="form-control-static">
                ...
                <div id="donations">
                    ...
                    @foreach($donations->take(10)->get() as $donation)
                    <div class="req-item my-3">
                        <div class="row">
                                ...
                                <div class="col-md-3 col-sm-12 text-center p-sm-3 pt-md-5"><a
                                        href="{{route('donation-details' , $donation->id)}}"
