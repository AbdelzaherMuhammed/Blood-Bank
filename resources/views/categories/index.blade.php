...
@section('content')
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                <form action="{{url(route('category-search'))}}" method="get" class="form-control-static">
            ...
            <div>
                <a href="{{route('category.create')}}" class="btn btn-primary"><i class="fa fa-plus"></i> اضافة
                    قسم جديد</a>
                        ...
                        @foreach($records as $record)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{url(route('category.edit' ,$record->id))}}"
